...
window.Modernizr=function(a,b,c){
	...
	var d="1.7",e={},f=!0,g=b.documentElement,
	h=b.head||b.getElementsByTagName("head")[0],
	i="modernizr",j=b.createElement(i),
	k=j.style,l=b.createElement("input"),m=":)",
	...
	w=function(a){
		...
		h.appendChild(c),d.id="modernizr",g.appendChild(d)
		,e=d.offsetHeight===3,c.parentNode.removeChild(c),
	...
	x=function(){
		function d(d,e){
			...
			f=C(e[d],"function"),C(e[d],c)||(e[d]=c),
			e.removeAttribute(d))),e=null;
			return f
		}
		...
		return y.call(a,b)
		  ...
		  r.cssanimations=function(){
			  return F("animationName")
				...
				e.input||G(),e.crosswindowmessaging=e.postmessage,e.historymanagement=e.history,
				e.addTest=function(a,b){
					a=a.toLowerCase();
					if(!e[a]){
						b=!!b(),g.className+=" "+(b?"":"no-")+a,e[a]=b;return e
						}
				},A(""),j=l=null,e._enableHTML5=f,e._version=d,
